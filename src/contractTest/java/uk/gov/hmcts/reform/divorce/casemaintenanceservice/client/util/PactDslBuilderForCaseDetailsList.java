...
public final class PactDslBuilderForCaseDetailsList {
    ...
    private static void getCaseData(final String emailAddress, final boolean withExecutors, final boolean withPayments,
        ...
        dataMap
            ...
            //    "D8DocumentsUploaded": [
            //            {
            //                "id": "059dadb4-04c1-44f9-9828-6194bfc9893c",
            //                "value": {
            //                    "DocumentComment": "",
            ...
            //                    "DocumentLink": {
            //                        "document_url": "http://dm-store-aat.service.core-compute-aat.internal/documents/7f63ca9b-c361-49ab-aa8c-8fbdb6bc2936"
            //                    },
            //                    "DocumentType": "other"
            //                }
            //            },
            //            {
            //                "id": "ac80c3ee-7a70-4d36-9f10-511b22fdc5fa",
            //                "value": {
            //                    "DocumentComment": "",
            //                    "DocumentDateAdded": "2017-12-11",
            //                    "DocumentEmailContent": "",
            ...
            //                    "DocumentLink": {
            //                        "document_url": "http://dm-store-aat.service.core-compute-aat.internal/documents/560f4bd1-fcf2-4dc5-80d1-d7e00d861683"
            //                    },
            //                    "DocumentType": "other"
            //                }
            //            }
    ...
    public static DslPart buildCaseDetailsDsl(Long caseId, String emailAddress, boolean withExecutors, boolean withPayments) {
        return newJsonBody((o) -> {
            o.numberType("id", caseId)
                ...
                .stringMatcher("state", "Draft|AwaitingPayment|CaseCreated", "AwaitingPayment")

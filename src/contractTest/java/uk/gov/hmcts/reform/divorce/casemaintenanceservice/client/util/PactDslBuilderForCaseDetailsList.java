                    ...
                    cd.numberType("outsideUKGrantCopies", 6)
                        ...
                        .object("declaration", (declaration) ->
                            declaration.stringType("accept", "I confirm that I will administer "
                                + "the estate of the person who died according to law, and that my application is truthful.")
                                ...
                                + "brought against us if we are found to have been deliberately untruthful or dishonest"))
                        .object("legalStatement", (legalStatement) ->
                            legalStatement.stringType("applicant", "We, Jon Snow of place make the "
                                ...
                                .minArrayLike("executorsNotApplying", 0, 1,
                                    executorNotApplying -> executorNotApplying
                                        .object("value", (value) ->
                                            value.stringType("executor", "Burton Leonard, an executor "
                                                + "named in the will or codicils, is not making this application because "

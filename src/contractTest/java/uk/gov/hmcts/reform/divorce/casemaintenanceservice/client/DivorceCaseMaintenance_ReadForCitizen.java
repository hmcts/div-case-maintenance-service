...
public class DivorceCaseMaintenance_ReadForCitizen {
    ...
    RequestResponsePact readForCitizen(PactDslWithProvider builder) {
        // @formatter:off
        return builder
            .given("A readForCitizen ********* TO CHANGE nt for caseworkder is  requested")
            .uponReceiving("A readForCitizen ********* TO CHANGE nt for caseworkder is  requested")
            .path("/citizens/"
                + USER_ID +
            ...
            .body(newJsonBody((caseDetailObject) -> {
                ...
                caseDetailObject.stringMatcher("jurisdiction", ALPHABETIC_REGEX, "DIVORCE");
                caseDetailObject.stringMatcher("case_type", ALPHABETIC_REGEX, "DIVORCE");
    ...
    public void verifyReadForCitizen() throws IOException, JSONException {
        ...
        assertThat(caseDetailsReponse.getCaseTypeId(), is("DIVORCE"));
